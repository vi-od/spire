    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 font-mono">
      ...
      <main id="main-content" className="p-4">
        ...
        <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/30 rounded border border-red-200 dark:border-red-800">
          <h3 className="font-bold text-red-800 dark:text-red-200 text-sm mb-2">⚡ C Resources</h3>
          <p className="text-red-700 dark:text-red-300 text-xs">
            C programming resources including system programming, memory management, 
            data structures, algorithms, and low-level development techniques.
          </p>
        </div>
