...
const PhpResourcesPage = () => {
  const items = [
    { name: '..', type: 'parent', path: '/resources/coding', size: '-', modified: '-' },
    { name: 'info.txt', type: 'file', path: '/resources/coding/php/info', size: '1.1 KB', modified: '12/15/2024' },
  ]
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 font-mono">
      ...
      <div className="bg-gray-100 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-600 px-4 py-2">
        <div className="text-sm text-gray-700 dark:text-gray-300">
          <span className="font-bold">PHP Resources - SPIRE File System</span>
        </div>
      </div>
      ...
      <main id="main-content" className="p-4">
        ...
        <div className="mb-4 p-3 bg-indigo-50 dark:bg-indigo-900/30 rounded border border-indigo-200 dark:border-indigo-800">
          <h3 className="font-bold text-indigo-800 dark:text-indigo-200 text-sm mb-2">🐘 PHP Resources</h3>
          <p className="text-indigo-700 dark:text-indigo-300 text-xs">
            PHP programming resources including Laravel framework, WordPress development, 
            web development patterns, and modern PHP practices.
          </p>
        </div>
        ...
        <div className="mt-4 pt-2 border-t border-gray-300 dark:border-gray-600">
          <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400">
            ...
            <span>SPIRE v1.0 | PHP Resources</span>
          </div>
        </div>
      </main>
    </div>
...
export default PhpResourcesPage 