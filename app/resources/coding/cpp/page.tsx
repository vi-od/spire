...
const CppResourcesPage = () => {
  const items = [
    { name: '..', type: 'parent', path: '/resources/coding', size: '-', modified: '-' },
    { name: 'info.txt', type: 'file', path: '/resources/coding/cpp/info', size: '1.2 KB', modified: '12/15/2024' },
  ]
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 font-mono">
      ...
      <div className="bg-gray-100 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-600 px-4 py-2">
        <div className="text-sm text-gray-700 dark:text-gray-300">
          <span className="font-bold">C++ Resources - SPIRE File System</span>
        </div>
      </div>
      ...
      <main id="main-content" className="p-4">
        ...
        <div className="mb-4 p-3 bg-purple-50 dark:bg-purple-900/30 rounded border border-purple-200 dark:border-purple-800">
          <h3 className="font-bold text-purple-800 dark:text-purple-200 text-sm mb-2">🔧 C++ Resources</h3>
          <p className="text-purple-700 dark:text-purple-300 text-xs">
            C++ programming resources including object-oriented programming, STL, templates, 
            modern C++ features, and system-level development.
          </p>
        </div>
        ...
        <div className="mt-4 pt-2 border-t border-gray-300 dark:border-gray-600">
          <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400">
            ...
            <span>SPIRE v1.0 | C++ Resources</span>
          </div>
        </div>
      </main>
    </div>
...
export default CppResourcesPage 