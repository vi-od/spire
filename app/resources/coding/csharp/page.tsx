...
const CSharpResourcesPage = () => {
  const items = [
    { name: '..', type: 'parent', path: '/resources/coding', size: '-', modified: '-' },
    { name: 'info.txt', type: 'file', path: '/resources/coding/csharp/info', size: '1.2 KB', modified: '12/15/2024' },
  ]
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 font-mono">
      ...
      <main id="main-content" className="p-4">
        ...
        <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/30 rounded border border-blue-200 dark:border-blue-800">
          <h3 className="font-bold text-blue-800 dark:text-blue-200 text-sm mb-2">🎯 C# Resources</h3>
          <p className="text-blue-700 dark:text-blue-300 text-xs">
            C# programming resources including .NET framework, ASP.NET, Entity Framework, 
...
export default CSharpResourcesPage 