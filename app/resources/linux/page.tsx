...
const LinuxResourcesPage = () => {
  const items = [
    { name: '..', type: 'parent', path: '/resources', size: '-', modified: '-' },
    { name: 'info.txt', type: 'file', path: '/resources/linux/info', size: '1.1 KB', modified: '12/15/2024' },
  ]
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 font-mono">
      ...
      <div className="bg-gray-100 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-600 px-4 py-2">
        <div className="text-sm text-gray-700 dark:text-gray-300">
          <span className="font-bold">Linux Resources - SPIRE File System</span>
        </div>
      </div>
      ...
      <main id="main-content" className="p-4">
        ...
        <div className="mb-4 p-3 bg-orange-50 dark:bg-orange-900/30 rounded border border-orange-200 dark:border-orange-800">
          <h3 className="font-bold text-orange-800 dark:text-orange-200 text-sm mb-2">🐧 Linux Resources</h3>
          <p className="text-orange-700 dark:text-orange-300 text-xs">
            Linux reference materials including command references, distribution guides, 
            configuration templates, and system administration resources.
          </p>
        </div>
        ...
        <div className="mt-4 pt-2 border-t border-gray-300 dark:border-gray-600">
          <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400">
            ...
            <span>SPIRE v1.0 | Linux Resources</span>
          </div>
        </div>
      </main>
    </div>
...
export default LinuxResourcesPage 