...
const WindowsResourcesPage = () => {
  const items = [
    { name: '..', type: 'parent', path: '/resources', size: '-', modified: '-' },
    { name: 'info.txt', type: 'file', path: '/resources/windows/info', size: '1.1 KB', modified: '12/15/2024' },
  ]
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 font-mono">
      ...
      <div className="bg-gray-100 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-600 px-4 py-2">
        <div className="text-sm text-gray-700 dark:text-gray-300">
          <span className="font-bold">Windows Resources - SPIRE File System</span>
        </div>
      </div>
      ...
      <main id="main-content" className="p-4">
        ...
        <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/30 rounded border border-blue-200 dark:border-blue-800">
          <h3 className="font-bold text-blue-800 dark:text-blue-200 text-sm mb-2">🪟 Windows Resources</h3>
          <p className="text-blue-700 dark:text-blue-300 text-xs">
            Windows reference materials including PowerShell guides, system configurations, 
            registry documentation, and administrative tools resources.
          </p>
        </div>
        ...
        <div className="mt-4 pt-2 border-t border-gray-300 dark:border-gray-600">
          <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400">
            ...
            <span>SPIRE v1.0 | Windows Resources</span>
          </div>
        </div>
      </main>
    </div>
...
export default WindowsResourcesPage 