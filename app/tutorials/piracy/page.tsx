...
const PiracyTutorialsPage = () => {
  const items = [
    { name: '..', type: 'parent', path: '/tutorials', size: '-', modified: '-' },
    { name: 'info.txt', type: 'file', path: '/tutorials/piracy/info', size: '1.4 KB', modified: '12/15/2024' },
  ]
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 font-mono">
      ...
      <div className="bg-gray-100 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-600 px-4 py-2">
        <div className="text-sm text-gray-700 dark:text-gray-300">
          <span className="font-bold">Piracy Tutorials - SPIRE File System</span>
        </div>
      </div>
      ...
      <main id="main-content" className="p-4">
        ...
        <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/30 rounded border border-red-200 dark:border-red-800">
          <h3 className="font-bold text-red-800 dark:text-red-200 text-sm mb-2">🏴‍☠️ Piracy Tutorials</h3>
          <p className="text-red-700 dark:text-red-300 text-xs">
            Educational tutorials about digital piracy methods, prevention techniques, copyright law, 
            and cybersecurity practices. For educational purposes only.
          </p>
        </div>
        ...
        <div className="mt-4 pt-2 border-t border-gray-300 dark:border-gray-600">
          <div className="flex justify-between text-xs text-gray-600 dark:text-gray-400">
            ...
            <span>SPIRE v1.0 | Piracy Tutorials</span>
          </div>
        </div>
      </main>
    </div>
...
export default PiracyTutorialsPage 